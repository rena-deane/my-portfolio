        ...
        <Modal show={this.state.showModal} onHide={this.close.bind(this)}>
          ...
          <Modal.Body>
            <p className='project-content'>
              The intention behind this project was use ReactJS and ThreeJS to create a virtual tour of the carvings that sit on top of Hikurangi maunga on the East Coast of the
